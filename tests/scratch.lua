...
local toml = tomlua { fancy_tables = false, strict = false, fancy_dates = false, multi_strings = false, mark_inline = false, int_keys = false }
local start_time, lastval, lasterr = os.clock()
for i = 1, iterations do
    local data, err = toml.decode(testtext)
    lastval, lasterr = data, err
end
local elapsed = os.clock() - start_time
print(stats("TOML", elapsed, iterations))
print(require("inspect")(lastval), lasterr)
